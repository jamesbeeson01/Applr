# gs_13_real_data_predict_vars.R
...
ggsave("testing/output/gs_13_real_data_predict_vars.png", plot = p, width = 7, height = 5)
message("OK: testing/output/gs_13_real_data_predict_vars.png")
