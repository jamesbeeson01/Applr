...
2. Add sections/examples for the newer functions the README doesn't cover:
...
3. Make the "Getting help" section link to the actual GitHub repo
   (`https://github.com/saundersg/Applr`) for issues.
4. Keep the friendly teaching tone; keep the Quick start near the top short.
