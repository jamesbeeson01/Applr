...
I tried to create captions for the slice_2d functions, but when you add additional lines, the captions write on top of each other. Also, how do you specify that this line is this value but that line is that value for the same variable? ggplot using a grouping to manage that and put it in the legend. Maybe I am just using base R wrong and there is a way, but a caption may not be ideal for add_slice_2d.
