...
something `geom_smooth()` only aspires to.
...
strings. Long equations are wrapped to the plot, and anything else you pass
goes to `lm_equation()` — `style = "brackets"` to always label factor terms
by level alone, for instance. Left alone, the style is chosen to fit the
plot.
