...
```{r slice-text-multiple, fig.show = "hold", out.width = "49%", fig.width = 4, fig.height = 3.2, fig.alt = "geom_slice_text plots labels with multiple predictors"}
...
```{r, slice-text-legend, fig.alt = "geom_slice_text labels multiple predictors with the 'legend' style"}
